...
const SearchInput = forwardRef<HTMLInputElement, SearchInputProps>(
  ({ className, type, ...props }, ref) => {
    return (
      <div className='fixed left-1/2 top-5 z-50 flex w-[80%] max-w-[30rem] -translate-x-1/2 transform items-center gap-3 rounded-[0.9375rem] border-b-[1px] border-input bg-white px-6 py-2 shadow-[0_4px_20px_2px_rgba(0,0,0,0.1)]'>
