...
function ListOfCallInquiry({ inquiries }:ListOfCallInquiryProps) {
  ...
  return (
    <div className='mx-auto w-full max-w-[1300px] rounded-lg border-gray-200 bg-white p-6 text-[1.25rem] font-bold leading-normal'
    style={{
      boxShadow:
          ...
          >
            <div className='flex items-center space-x-2'>
              ...
              <span className='font-semibold text-gray-800'>
                {inquiry.inquiry_content.length <= 15
                  ? inquiry.inquiry_content
                  : `${inquiry.inquiry_content.substring(0, 15)}...`}
              </span>
              <Badge
                variant='lightSolid'
            ...
            <button
              ...
              onClick={() => navigate(`/admin/online/call/${inquiry.call_id}`)}
            >
              상세보기
